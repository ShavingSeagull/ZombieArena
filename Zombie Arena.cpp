...
int main()
{
	...
	Texture textureSpriteIcon = TextureHolder::GetTexture("graphics/ammo_icon.png");
	spriteAmmoIcon.setTexture(textureSpriteIcon);
	...
	while (window.isOpen())
	{
		...
		*/
		...
		if (state == State::LEVELING_UP)
		{
			...
			if (state == State::PLAYING)
			{
				...
				numZombies = 5 * wave;
				// Delete the previously allocated memory (it it exists)
				delete[] zombies;
		...
		*/
		if (state == State::PLAYING)
		{
			...
			// Re-calculate every fspMeasurementFrameInterval frames
